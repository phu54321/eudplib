'''
eudtrglib library. This library follows zlib license.
eudtrglib consists of 2 subpackages.

- base : Core of eudtrglib. lib is implemented using base subpackage.
...
0.23-r2
 - eudtrglib now alerts about payload size.
...
0.22-r1
 - eudtrglib now requires only 1 computer player to work properly.
