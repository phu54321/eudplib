...
class EUDObject(Expr):
    ...
    :class:`eudtrglib.Trigger` refers to that memory chunk, and can create 2408
    ...
    def SetAddress(self, address):
        '''
        Called by eudtrglib when address of object is fixed. You won't need to
        override this function.
        '''
        assert self._address is None, 'Might be eudtrglib bug. Report this.'
    ...
    def ResetAddress(self):
        ...
        '''
        assert self._address is not None, 'Might be eudtrglib bug. Report this.'
        self._address = None


    def EvalImpl(self):
        '''
        Overrides :meth:`eudtrglib.Expr.EvalImpl` .
    ...
    def GetDependencyList(self):
        '''
        Overrides :meth:`eudtrglib.Expr.GetDependencyList` .
