...
def test_eudscand():
    ...
    test_assert("EUDSCAnd w. (true, false)", EUDNot(EUDSCAnd()(Always())(Never())()))
    test_assert("EUDSCAnd w. (false, false)", EUDNot(EUDSCAnd()(Never())(Never())()))
...
def test_eudscor():
    ...
    test_assert("EUDSCOr w. (false, false)", EUDNot(EUDSCOr()(Never())(Never())()))
